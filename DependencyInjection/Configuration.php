    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('hackzilla_ticket')
            ->children()
                ...
                ->scalarNode('message_attachment_class')->cannotBeEmpty()->defaultValue('Hackzilla\Bundle\TicketBundle\Entity\TicketMessageAttachment')->end()
                    ->arrayNode('features')
                    ->addDefaultsIfNotSet()
                    ->children()
                ...
                ->arrayNode('from_mail')
                    ...
                    ->children()
                        ...
                        ->arrayNode('templates')
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('mails_out_not_allowed')
                        ->defaultValue([''])
                            ->prototype('scalar')
                            ->end()
                        ->end()
